...
const Services = () => (
  <div>
        ...
        {sections.map((section, si) => (
          ...
          >
            <motion.div variants={fadeUp} custom={0} className={si % 2 === 1 ? "lg:order-2" : ""}>
              <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-primary/20 to-accent flex items-center justify-center mb-5">
              ...
              <Link
                to="/contact"
                className="inline-flex items-center gap-2 rounded-xl bg-gradient-to-r from-primary to-accent text-white px-6 py-3 font-semibold hover:shadow-lg hover:shadow-primary/25 hover:scale-105 transition-all duration-200"
              >
            ...
            <motion.div variants={fadeUp} custom={1} className={si % 2 === 1 ? "lg:order-1" : ""}>
              <div className="grid gap-3">
                {section.items.map((item, i) => (
                  ...
                  >
                    <div className="w-10 h-10 rounded-lg bg-gradient-to-br from-primary/20 to-accent flex items-center justify-center shrink-0 group-hover:scale-110 transition-transform">
    ...
    {/* CTA */}
    <section className="py-24 bg-gradient-to-br from-primary/5 to-accent">
      <div className="container mx-auto px-4 text-center">
        ...
        <Link
          to="/contact"
          className="inline-flex items-center gap-2 rounded-xl bg-gradient-to-r from-primary to-accent text-white px-10 py-4 text-lg font-bold hover:shadow-2xl hover:shadow-primary/25 hover:scale-105 transition-all duration-200"
        >
